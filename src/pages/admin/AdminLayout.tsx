        ...
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          ...
          <Link to="/admin/dashboard" className="flex items-center gap-3">
            ...
            <div className="flex items-baseline">
              <span className="text-2xl font-black text-gray-900 font-montserrat-alt uppercase tracking-tight">Auronex</span>
              <span className="text-2xl font-medium text-primary font-montserrat-alt uppercase tracking-tight">Media</span>
            </div>
          </Link>
