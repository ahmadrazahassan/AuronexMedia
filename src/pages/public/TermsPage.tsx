...
export const TermsPage: React.FC = () => {
  return (
    <div className="bg-white">
      <Navbar />
      <SEO
        title="Terms of Service | AuronexMedia"
        description="Read our terms of service to understand the rules and regulations for using AuronexMedia."
      />
          ...
          <div className="max-w-4xl mx-auto space-y-12">
            ...
            <div className="p-8 bg-gray-50 border-4 border-dark">
              ...
              <p className="text-gray-700 font-sf-pro leading-relaxed text-lg">
                By accessing AuronexMedia, you agree to be bound by these Terms of Service and all applicable laws and regulations. If you do not agree with any of these terms, you are prohibited from using this site.
              </p>
            </div>
            ...
            <div className="p-8 border-l-4 border-primary">
              ...
              <p className="text-gray-700 font-sf-pro leading-relaxed text-lg mb-4">
                Permission is granted to temporarily access the materials on AuronexMedia for personal, non-commercial viewing only. This is the grant of a license, not a transfer of title. Under this license, you may not:
              </p>
            ...
            <div className="p-8 bg-gray-50 border-4 border-dark">
              ...
              <p className="text-gray-700 font-sf-pro leading-relaxed text-lg">
                All content published on AuronexMedia is owned by us or licensed to us. You may not reproduce, distribute, or create derivative works from our content without explicit permission.
              </p>
            </div>
            ...
            <div className="p-8 bg-gray-50 border-4 border-dark">
              ...
              <p className="text-gray-700 font-sf-pro leading-relaxed text-lg">
                The materials on AuronexMedia are provided "as is". We make no warranties, expressed or implied, and hereby disclaim all other warranties including implied warranties or conditions of merchantability, fitness for a particular purpose, or non-infringement of intellectual property.
              </p>
            </div>
            ...
            <div className="p-8 border-l-4 border-primary">
              ...
              <p className="text-gray-700 font-sf-pro leading-relaxed text-lg">
                In no event shall AuronexMedia or its suppliers be liable for any damages (including, without limitation, damages for loss of data or profit) arising out of the use or inability to use our materials.
              </p>
            </div>
