...
export const PrivacyPage: React.FC = () => {
  return (
    <div className="bg-white">
      <Navbar />
      <SEO
        title="Privacy Policy | AuronexMedia"
        description="Learn how AuronexMedia collects, uses, and protects your personal information."
      />
          ...
          <div className="max-w-4xl mx-auto space-y-12">
            ...
            <div className="p-8 bg-gray-50 border-4 border-dark">
              ...
              <p className="text-gray-700 font-sf-pro leading-relaxed text-lg">
                At AuronexMedia, we take your privacy seriously. This Privacy Policy explains how we collect, use, and protect your information when you visit our website.
              </p>
            </div>
