...
export const AdvertisePage: React.FC = () => {
  ...
  return (
    <div className="bg-white">
      <Navbar />
      <SEO
        title="Advertise With Us | AuronexMedia"
        description="Reach a highly engaged audience of developers, designers, and tech professionals. Explore our advertising options and grow your brand with AuronexMedia."
      />
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {packages.map((pkg, index) => (
              ...
              >
                ...
                <Link
                  to="/contact"
                  className={`block w-full py-4 text-center font-sf-pro font-bold text-sm tracking-wider uppercase transition-all ${pkg.featured
