...
export const LicensesPage: React.FC = () => {
  return (
    <div className="bg-white">
      <Navbar />
      <SEO
        title="Licenses & Attributions | AuronexMedia"
        description="Third-party licenses and attributions for AuronexMedia."
      />
          ...
          <div className="max-w-4xl mx-auto space-y-12">
            ...
            <div className="p-8 bg-gray-50 border-4 border-dark">
              ...
              <p className="text-gray-700 font-sf-pro leading-relaxed text-lg">
                AuronexMedia is built using various open source libraries and frameworks. We are grateful to the open source community for their contributions.
              </p>
            </div>
