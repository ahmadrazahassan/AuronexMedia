...
export const CareersPage: React.FC = () => {
  ...
  return (
    <div className="bg-white">
      <Navbar />
      <SEO
        title="Careers - Join Our Team | AuronexMedia"
        description="Join AuronexMedia and help shape the future of digital publishing. Explore open positions and become part of our innovative team."
      />
