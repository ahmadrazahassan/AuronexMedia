...
export const BlogPage: React.FC = () => {
  ...
  return (
    <>
      <SEO
        title="Blog - AuronexMedia"
        description="Read our latest articles and stories on AuronexMedia."
      />
      <Navbar />
          ...
          <div className="mt-4">
            <div className="flex flex-wrap gap-2">
              <button
                ...
                className={`px-3 py-1 text-sm rounded-button transition-colors ${!selectedTag
              ...
              {tags.map((tag) => (
                <button
                  ...
                  className={`px-3 py-1 text-sm rounded-button transition-colors ${selectedTag === tag.id
                      ? 'bg-primary text-white'
                      : 'bg-gray-100 text-secondary hover:bg-gray-200'
                    }`}
                >
